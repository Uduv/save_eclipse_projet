 ...
 * </p>
 * <ul>
 *   <li>{@link fr.univcotedazur.l3ia.langagecompilation.impl.ActuatorImpl#getPortID <em>Port ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ActuatorImpl extends StatementImpl implements Actuator {
	/**
	...
	protected EClass eStaticClass() {
		return LegolanguagePrPackage.Literals.ACTUATOR;
	}
	...
	public void setPortID(String newPortID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LegolanguagePrPackage.ACTUATOR__PORT_ID, oldPortID,
					portID));
	}
