 ...
 * </p>
 * <ul>
 *   <li>{@link fr.univcotedazur.l3ia.langagecompilation.impl.PrintImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrintImpl extends StatementImpl implements Print {
	...
	protected EClass eStaticClass() {
		return LegolanguagePrPackage.Literals.PRINT;
	}
	...
	public EList<Statement> getStatement() {
		if (statement == null) {
			statement = new EObjectContainmentEList<Statement>(Statement.class, this,
					LegolanguagePrPackage.PRINT__STATEMENT);
		}
		return statement;
	}
