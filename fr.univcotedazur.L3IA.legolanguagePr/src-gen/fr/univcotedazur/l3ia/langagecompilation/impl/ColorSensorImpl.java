 ...
 * </p>
 * <ul>
 *   <li>{@link fr.univcotedazur.l3ia.langagecompilation.impl.ColorSensorImpl#getColor <em>Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColorSensorImpl extends SensorImpl implements ColorSensor {
	...
	protected EClass eStaticClass() {
		return LegolanguagePrPackage.Literals.COLOR_SENSOR;
	}
	...
	public void setColor(Color newColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LegolanguagePrPackage.COLOR_SENSOR__COLOR, oldColor,
					color));
	}
