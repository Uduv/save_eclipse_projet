...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Change Intensity Light</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.univcotedazur.l3ia.langagecompilation.impl.ChangeIntensityLightImpl#getIntensity <em>Intensity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChangeIntensityLightImpl extends ActuatorOperationImpl implements ChangeIntensityLight {
	/**
	 ...
	 * @generated
	 */
	protected ChangeIntensityLightImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return LegolanguagePrPackage.Literals.CHANGE_INTENSITY_LIGHT;
	}
	...
	public NotificationChain basicSetIntensity(Expression newIntensity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LegolanguagePrPackage.CHANGE_INTENSITY_LIGHT__INTENSITY, oldIntensity, newIntensity);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newIntensity != intensity) {
			...
			if (intensity != null)
				msgs = ((InternalEObject) intensity).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - LegolanguagePrPackage.CHANGE_INTENSITY_LIGHT__INTENSITY, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					LegolanguagePrPackage.CHANGE_INTENSITY_LIGHT__INTENSITY, newIntensity, newIntensity));
	}
