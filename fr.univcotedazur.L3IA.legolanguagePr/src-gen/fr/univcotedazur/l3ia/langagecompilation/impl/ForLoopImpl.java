 ...
 * </p>
 * <ul>
 *   <li>{@link fr.univcotedazur.l3ia.langagecompilation.impl.ForLoopImpl#getLoopCondition <em>Loop Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForLoopImpl extends LoopImpl implements ForLoop {
	...
	protected EClass eStaticClass() {
		return LegolanguagePrPackage.Literals.FOR_LOOP;
	}
	...
	public NotificationChain basicSetLoopCondition(Condition newLoopCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LegolanguagePrPackage.FOR_LOOP__LOOP_CONDITION, oldLoopCondition, newLoopCondition);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLoopCondition != loopCondition) {
			...
			if (loopCondition != null)
				msgs = ((InternalEObject) loopCondition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - LegolanguagePrPackage.FOR_LOOP__LOOP_CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LegolanguagePrPackage.FOR_LOOP__LOOP_CONDITION,
