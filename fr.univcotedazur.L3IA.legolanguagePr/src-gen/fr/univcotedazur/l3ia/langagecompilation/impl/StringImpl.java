 ...
 * </p>
 * <ul>
 *   <li>{@link fr.univcotedazur.l3ia.langagecompilation.impl.StringImpl#getInitialeValue <em>Initiale Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringImpl extends VariableImpl implements fr.univcotedazur.l3ia.langagecompilation.String {
	/**
	...
	protected EClass eStaticClass() {
		return LegolanguagePrPackage.Literals.STRING;
	}
	...
	public void setInitialeValue(String newInitialeValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LegolanguagePrPackage.STRING__INITIALE_VALUE,
