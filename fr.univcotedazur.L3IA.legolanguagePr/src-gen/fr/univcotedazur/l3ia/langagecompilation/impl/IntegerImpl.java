 ...
 * </p>
 * <ul>
 *   <li>{@link fr.univcotedazur.l3ia.langagecompilation.impl.IntegerImpl#getInitialeValue <em>Initiale Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerImpl extends VariableImpl implements fr.univcotedazur.l3ia.langagecompilation.Integer {
	/**
	...
	protected EClass eStaticClass() {
		return LegolanguagePrPackage.Literals.INTEGER;
	}
	...
	public void setInitialeValue(int newInitialeValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LegolanguagePrPackage.INTEGER__INITIALE_VALUE,
