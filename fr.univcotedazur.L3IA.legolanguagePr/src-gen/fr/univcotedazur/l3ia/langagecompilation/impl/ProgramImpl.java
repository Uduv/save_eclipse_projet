 ...
 * </p>
 * <ul>
 *   <li>{@link fr.univcotedazur.l3ia.langagecompilation.impl.ProgramImpl#getStatement <em>Statement</em>}</li>
 *   <li>{@link fr.univcotedazur.l3ia.langagecompilation.impl.ProgramImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program {
	...
	protected EClass eStaticClass() {
		return LegolanguagePrPackage.Literals.PROGRAM;
	}
	...
	public EList<Statement> getStatement() {
		if (statement == null) {
			statement = new EObjectContainmentEList<Statement>(Statement.class, this,
					LegolanguagePrPackage.PROGRAM__STATEMENT);
		}
		return statement;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LegolanguagePrPackage.PROGRAM__NAME, oldName, name));
	}
