 ...
 * </p>
 * <ul>
 *   <li>{@link fr.univcotedazur.l3ia.langagecompilation.impl.LoopImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class LoopImpl extends StatementImpl implements Loop {
	...
	protected EClass eStaticClass() {
		return LegolanguagePrPackage.Literals.LOOP;
	}
	...
	public EList<Statement> getStatement() {
		if (statement == null) {
			statement = new EObjectContainmentEList<Statement>(Statement.class, this,
					LegolanguagePrPackage.LOOP__STATEMENT);
		}
		return statement;
	}
