 ...
 * @generated
 */
public class GyroSensorItemProvider extends SensorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public GyroSensorItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GyroSensor"));
	}
	...
	public String getText(Object object) {
		String label = ((GyroSensor) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_GyroSensor_type")
				: getString("_UI_GyroSensor_type") + " " + label;
	}
