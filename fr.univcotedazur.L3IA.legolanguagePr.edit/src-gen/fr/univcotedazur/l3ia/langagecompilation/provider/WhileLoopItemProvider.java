...
/**
 * This is the item provider adapter for a {@link fr.univcotedazur.l3ia.langagecompilation.WhileLoop} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WhileLoopItemProvider extends LoopItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LegolanguagePrPackage.Literals.WHILE_LOOP__LOOP_CONDITION);
		}
	...
	public String getText(Object object) {
		String label = ((WhileLoop) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_WhileLoop_type")
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == LegolanguagePrPackage.Literals.LOOP__STATEMENT
				|| childFeature == LegolanguagePrPackage.Literals.WHILE_LOOP__LOOP_CONDITION;
