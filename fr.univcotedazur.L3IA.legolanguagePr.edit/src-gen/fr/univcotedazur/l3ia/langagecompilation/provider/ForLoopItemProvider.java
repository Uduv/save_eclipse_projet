...
/**
 * This is the item provider adapter for a {@link fr.univcotedazur.l3ia.langagecompilation.ForLoop} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ForLoopItemProvider extends LoopItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LegolanguagePrPackage.Literals.FOR_LOOP__LOOP_CONDITION);
		}
	...
	public String getText(Object object) {
		String label = ((ForLoop) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ForLoop_type")
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == LegolanguagePrPackage.Literals.LOOP__STATEMENT
				|| childFeature == LegolanguagePrPackage.Literals.FOR_LOOP__LOOP_CONDITION;
