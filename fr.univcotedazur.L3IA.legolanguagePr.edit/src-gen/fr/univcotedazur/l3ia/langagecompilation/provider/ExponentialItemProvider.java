...
/**
 * This is the item provider adapter for a {@link fr.univcotedazur.l3ia.langagecompilation.Exponential} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExponentialItemProvider extends CalculItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((Exponential) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Exponential_type")
				: getString("_UI_Exponential_type") + " " + label;
	}
