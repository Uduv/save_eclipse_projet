...
/**
 * This is the item provider adapter for a {@link fr.univcotedazur.l3ia.langagecompilation.Equal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EqualItemProvider extends ComparaisonItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((Equal) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Equal_type")
				: getString("_UI_Equal_type") + " " + label;
	}
