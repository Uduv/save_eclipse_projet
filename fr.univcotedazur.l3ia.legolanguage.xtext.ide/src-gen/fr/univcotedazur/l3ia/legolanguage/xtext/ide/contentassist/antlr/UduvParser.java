...
public class UduvParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, UduvGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getLeIntegerAccess().getInitialeValueAssignment_4(), "rule__LeInteger__InitialeValueAssignment_4");
			builder.put(grammarAccess.getLeStringAccess().getNameAssignment_2(), "rule__LeString__NameAssignment_2");
			builder.put(grammarAccess.getLeStringAccess().getInitialeValueAssignment_3(), "rule__LeString__InitialeValueAssignment_3");
			builder.put(grammarAccess.getLeBooleanAccess().getNameAssignment_2(), "rule__LeBoolean__NameAssignment_2");
			builder.put(grammarAccess.getLeBooleanAccess().getInitialeValueAssignment_3(), "rule__LeBoolean__InitialeValueAssignment_3");
			builder.put(grammarAccess.getLeFloatAccess().getNameAssignment_2(), "rule__LeFloat__NameAssignment_2");
			builder.put(grammarAccess.getLeFloatAccess().getInitialeValueAssignment_3(), "rule__LeFloat__InitialeValueAssignment_3");
