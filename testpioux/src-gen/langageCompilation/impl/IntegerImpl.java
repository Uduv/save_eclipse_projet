 ...
 * </p>
 * <ul>
 *   <li>{@link langageCompilation.impl.IntegerImpl#getInitialValue <em>Initial Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerImpl extends VariableImpl implements langageCompilation.Integer {
	/**
	...
	protected EClass eStaticClass() {
		return TestpiouxPackage.Literals.INTEGER;
	}
	...
	public void setInitialValue(int newInitialValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestpiouxPackage.INTEGER__INITIAL_VALUE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case TestpiouxPackage.INTEGER__INITIAL_VALUE:
