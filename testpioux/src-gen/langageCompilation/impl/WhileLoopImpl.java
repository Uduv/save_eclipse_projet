...
public class WhileLoopImpl extends LoopImpl implements WhileLoop {
	...
	protected EClass eStaticClass() {
		return TestpiouxPackage.Literals.WHILE_LOOP;
	}
	...
	public NotificationChain basicSetLoopCondition(Expression newLoopCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					TestpiouxPackage.WHILE_LOOP__LOOP_CONDITION, oldLoopCondition, newLoopCondition);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLoopCondition != loopCondition) {
			...
			if (loopCondition != null)
				msgs = ((InternalEObject) loopCondition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - TestpiouxPackage.WHILE_LOOP__LOOP_CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, TestpiouxPackage.WHILE_LOOP__LOOP_CONDITION,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case TestpiouxPackage.WHILE_LOOP__LOOP_CONDITION:
