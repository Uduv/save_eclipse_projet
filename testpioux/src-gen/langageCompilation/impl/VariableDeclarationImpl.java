 ...
 * </p>
 * <ul>
 *   <li>{@link langageCompilation.impl.VariableDeclarationImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableDeclarationImpl extends StatementImpl implements VariableDeclaration {
	...
	protected EClass eStaticClass() {
		return TestpiouxPackage.Literals.VARIABLE_DECLARATION;
	}
	...
	public EList<Variable> getVariable() {
		if (variable == null) {
			variable = new EObjectContainmentEList<Variable>(Variable.class, this,
					TestpiouxPackage.VARIABLE_DECLARATION__VARIABLE);
		}
		return variable;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case TestpiouxPackage.VARIABLE_DECLARATION__VARIABLE:
